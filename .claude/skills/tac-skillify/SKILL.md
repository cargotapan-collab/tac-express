...
description: >-
  ...
  adapted to TAC Express's 14-laws + Vitest/Playwright stack.
---
...
[ ]  7. Tests               — Vitest unit + Playwright E2E if it touches UI
...
|---|---|
| UI authoring | Vitest component test + Playwright visual regression |
