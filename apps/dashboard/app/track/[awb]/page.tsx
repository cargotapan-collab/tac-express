...
function NotFound({ awb, reason }: { awb: string; reason: string }) {
  return (
    <div className="space-y-4 border border-dashed border-border bg-card p-8 text-center">
      ...
      <Link
        href="/track"
        className="inline-flex items-center gap-1.5 border border-border px-3 py-1.5 font-mono text-[11px] uppercase tracking-widest text-foreground transition-colors hover:border-primary hover:text-primary"
      >
        Try another CN
