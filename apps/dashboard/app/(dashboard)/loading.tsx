    ...
    <div data-slot="dashboard-loading" className="space-y-6">
      ...
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 flex-1 space-y-2">
          ...
          <div className="h-7 w-64 bg-muted animate-pulse" />
          <div className="h-4 w-96 max-w-full bg-muted animate-pulse" />
        </div>
        <div className="h-9 w-32 bg-muted animate-pulse shrink-0" />
      </header>
        ...
        <div className="divide-y divide-border">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="p-4 flex items-center gap-4">
              <div className="h-3 w-24 bg-muted animate-pulse" />
              <div className="h-3 w-32 bg-muted animate-pulse flex-1" />
