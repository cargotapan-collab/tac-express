...
- Layered LB-5 + LB-6 + § 4.7 owner env-var input + § 1.4 customer-facing workstream entry on top.
...
**Launch-surface (carried from the 2026-05-18 reconciliation, all still open):**
