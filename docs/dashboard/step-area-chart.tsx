...
/**
 * Right-angled step area chart. Honours discrete-event semantics:
 * each value persists until the next observation. Curves are forbidden
 * by the design system; this primitive is the only allowed time-series
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip
            ...
            content={
              <OrbitalTooltip formatValue={formatTooltipValue} />
            }
          />
          {labels.y2 ? (
            <Area
