...
function HubPin({
  ...
  return (
    <div className="group/hub-pin relative flex flex-col items-center">
      <div className="pointer-events-none flex h-7 items-center gap-1.5 border border-primary/40 bg-background/95 px-2 font-mono text-[10px] font-semibold uppercase tracking-widest text-foreground shadow-[var(--shadow-brutal-sm)]">
        <span
          className={cn(
            "size-1.5",
      ...
      <div className="pointer-events-none absolute -bottom-7 z-10 hidden whitespace-nowrap border border-border bg-popover px-2 py-0.5 font-mono text-[10px] uppercase tracking-widest text-popover-foreground group-hover/hub-pin:block">
        {name}
        {secondary ? ` · ${secondary}` : ""}
      </div>
    </div>
