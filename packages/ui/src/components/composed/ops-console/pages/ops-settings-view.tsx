    ...
    <div className="grid grid-cols-[1.5fr_1fr] gap-[length:var(--spacing-gutter-md)]">
                ...
                <div className="flex-1 min-w-0 flex items-center gap-2">
                  {isEditing ? (
                    ...
                    <div className="min-w-0">
                      <div className="font-paper-display font-semibold text-[length:var(--text-paper-13)] text-paper-fg-1 truncate">
                        {display}
                      </div>
          ...
          <div className="mt-4 pt-3.5 border-t border-paper-line">
            ...
            <ul className="divide-y divide-paper-line">
              {config.hidden.map((code) => (
                ...
                >
                  <div className="min-w-0">
                    <div className="font-paper-display font-medium text-[length:var(--text-paper-13)] text-paper-fg-2 truncate line-through">
      ...
      <div className="flex flex-col gap-3.5">
        <OpsCard ticks>
          ...
          <p className="font-paper-display text-[length:var(--text-paper-13)] mt-2 leading-relaxed text-paper-fg-2">
        ...
        <OpsCard>
          ...
          <ul className="font-paper-display text-[length:var(--text-paper-13)] mt-2 leading-relaxed text-paper-fg-2 list-disc pl-4 space-y-1">
