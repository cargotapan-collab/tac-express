      ...
      <div className="grid grid-cols-[1.4fr_1fr] gap-[18px]">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div>
              <div className="font-paper-display font-bold text-[length:var(--text-paper-16)]">
                Inbox
              </div>
          ...
          >
            <div>
              ...
              <div className="font-paper-display font-bold text-[length:var(--text-paper-16)] mt-1">
                No notifications yet
              </div>
              <div className="font-paper-display text-[length:var(--text-paper-13)] text-paper-fg-3 mt-1 max-w-sm">
