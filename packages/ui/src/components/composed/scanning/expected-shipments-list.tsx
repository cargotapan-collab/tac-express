    ...
    >
      ...
      <div className="border border-border bg-background">
        <ScrollArea className="h-96">
          {filtered.length === 0 ? (
            <div className="flex h-96 items-center justify-center font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <a
                      ...
                      className="block truncate font-mono text-[11px] font-semibold tracking-widest hover:underline"
                    >
                      {it.awbNumber}
                    </a>
