    ...
    editorProps: {
      attributes: {
        ...
        class: cn(
          ...
          "prose-code:font-mono prose-code:text-[11px] prose-code:bg-muted prose-code:px-1 prose-code:py-0.5",
          "dark:prose-invert"
        ),
  ...
  return (
    ...
    >
      ...
      {characterLimit && editor && (
        <div className="flex items-center justify-end border-t border-border px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
