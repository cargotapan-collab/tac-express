...
function BarcodeScanner({
  ...
  return (
    ...
    >
      ...
      {error && (
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-background/90 px-4 text-center font-mono text-[11px] uppercase tracking-widest text-destructive">
